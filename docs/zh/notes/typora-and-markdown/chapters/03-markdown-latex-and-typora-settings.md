...
![代码块与语法高亮](images/Figure%203-3-1.png)

> **图 3-3**：Python 和 Bash 代码块语法高亮效果

![JSON 代码块](images/Figure%203-3-2.png)
...
![行内公式设置与示例](images/Figure%203-4.png)
...
![Markdown 语法支持设置](images/settings4.png)
...
![公式与代码块设置](images/settings5.png)

> **图 3-8**：Typora Markdown 设置中的代码围栏选项和 Math 设置

![Math 详细设置](images/settings6.png)
