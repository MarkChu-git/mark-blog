...
![标题层级与大纲联动](images/Figure%203-1.heic)
...
![列表与嵌套](images/Figure%203-2.heic)
...
![代码块与语法高亮 - Python](images/Figure%203-3-1.heic)

![代码块与语法高亮 - Bash](images/Figure%203-3-2.heic)

> **图 3-3**：带语言标识的代码块（Python 和 Bash），展示语法高亮效果
...
![行内公式设置](images/Figure%203-4.heic)
...
![块级公式与多行对齐](images/Figure%203-5.heic)

> **图 3-5**：块级公式与多行对齐公式的渲染效果
...
![Markdown 设置 - 第1页](images/settings1.heic)

![Markdown 设置 - 第2页](images/settings2.heic)

![Markdown 设置 - 第3页](images/settings3.heic)

> **图 3-6**：Typora Markdown 设置总览，包含 Inline Math、Footnote、Highlight、Subscript/Superscript 等关键选项
...
![图片设置 - 第1页](images/settings4.heic)

![图片设置 - 第2页](images/settings5.heic)

> **图 3-7**：Typora 图片设置，展示图片插入路径和相对路径选项
...
![快捷键与菜单入口](images/settings6.heic)

> **图 3-8**：Typora 快捷键与菜单入口展示
